...
3. Create a new folder `api` in your `src` folder
4. Create a new folder `routes` in your `api` folder
5. Create a new folder `controllers` in your `api` folder
6. Create a new folder `models` in your `api` folder
7. Based on the examples above create an Express project with the following routes:
